  ...
  return (
    <div className="flex gap-2">
      <div className="flex gap-1">
        ...
        {value >= 6 ? <Full /> : value >= 5.5 ? <Half /> : <Empty />}
        {value >= 7 ? <Full /> : value >= 6.5 ? <Half /> : <Empty />}
        {value >= 8 ? <Full /> : value >= 7.5 ? <Half /> : <Empty />}
        {value >= 9 ? <Full /> : value >= 8.5 ? <Half /> : <Empty />}
        {value >= 10 ? <Full /> : value >= 9.5 ? <Half /> : <Empty />}
      </div>
