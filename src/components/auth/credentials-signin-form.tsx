  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-4">
        <CustomSignIn text="Login with Apple" provider="apple" icon={<Apple />} />
        <CustomSignIn text="Login with Google" provider="google" icon={<Google />} />
        <CustomSignIn text="Login with Github" provider="github" icon={<Github />} />
      </div>
    </>
  );
};
