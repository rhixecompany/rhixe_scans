...
export const insertComicImageSchema = z.object({
  ...
  image: z.string().min(3, "Image must be at least 3 characters").optional().nullable(),
  checksum: z.string().min(3, "Checksum must be at least 3 characters").optional().nullable(),
  status: imagestatus,
...
export const insertComicSchema = z.object({
  ...
  status: comicstatus,
  link: z.string().min(3, "Link must be at least 3 characters"),
  serialization: z.string().min(3, "Serialization must be at least 3 characters"),
  numimages: z.number().int().nonnegative("NumImages must be a positive number"),
  numchapters: z.number().int().nonnegative("NumChapters must be a positive number"),
