...
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || "Read Comics";
...
export const DEFAULT_IMAGE_STATUS = process.env.DEFAULT_IMAGE_STATUS || "downloaded";
